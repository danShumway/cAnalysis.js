...
sets.push([
  ...
  },
  {
    ...
    "cost": 0,
    "set": 4,
    "text": "Worth 1 VP for every three Action cards in your deck (rounded down).",
    "type": "Victory",
    "actions": 0,
    "buys": 0,
    "treasure": 0,
  ...
  },
  {
    ...
    "set": 4,
    "cards": 2,
    "text": "When you discard this from play, you may put this on top of your deck if you have a Potion in play.",
    "type": "Action",
    "buys": 0,
    "treasure": 0,
    "victoryPoints": 0,
  ...
  },
  {
    ...
    "buys": 1,
    "set": 4,
    "text": "The player to your left takes an extra turn after this one, in which you can see all cards he can and make all decisions for him. Any card he would gain on that turn, you gain instead; any cards of his that are trashed are set aside and returned to his discard pile at the end of turn.",
    "type": "Action",
    "treasure": 0,
    "cards": 0,
    "victoryPoints": 0,
  ...
  },
  {
    ...
    "treasure": 1,
    "set": 4,
    "text": "When you discard this from play, you may put one of your Treasures from play on top of your deck.",
    "type": "Action",
    "actions": 0,
    "cards": 0,
    "victoryPoints": 0,
  ...
  },
  {
    ...
    "actions": 2,
    "set": 4,
    "text": "+You may gain an Action card costing up to 5 Coins.",
    "type": "Action",
    "buys": 0,
    "treasure": 0,
    "cards": 0,
  ...
  },
  {
    ...
    "actions": 1,
    "set": 4,
    "text": "Each player (including you) reveals the top card of his deck and either discards it or puts it back, your choice. Then reveal cards from the top of your deck until you reveal one that is not an Action. Put all of your revealed cards into your hand.",
    "type": "Action - Attack",
    "buys": 0,
    "treasure": 0,
    "cards": 0,
  ...
  },
  {
    ...
    "set": 4,
    "cards": 1,
    "text": "Reveal the top 4 cards of your deck. Put the revealed Coppers and Potions into your hand. Put the other cards back on top of your deck in any order.",
    "type": "Action",
    "buys": 0,
    "treasure": 0,
    "victoryPoints": 0,
  ...
  },
  {
    ...
    "actions": 1,
    "set": 4,
    "text": "Trash a card from your hand. Plus 1 Card per Coin it costs. +2 Cards if it has a Potion in its cost.",
    "type": "Action",
    "buys": 0,
    "treasure": 0,
    "cards": 0,
  ...
  },
  {
    ...
    "actions": 0,
    "set": 4,
    "text": "Reveal cards from your deck until you reveal 2 Action cards other than a Golem card. Discard the other cards, then play the Action cards in either order.",
    "type": "Action",
    "buys": 0,
    "treasure": 0,
    "cards": 0,
  ...
  },
  {
    ...
    "actions": 2,
    "set": 5,
    "text": "If there are one or more empty Supply piles, +1 card. If there are two or more, +1 Coin and +1 Buy.",
    "description": "You draw a card and can play two more Actions no matter what. If there is just one empty pile in the Supply, you also draw another card. If there are two or more empty piles, you both draw another card, and get 1 coin to spend and an extra Buy to use in the Buy phase. There are no further bonuses if three or more piles are empty. This only checks how many piles are empty when you play it; if piles become empty later in the turn, you do not go back and get the bonuses. If a pile stops being empty due to cards being returned to it, such as with the Dominion: Seaside card Ambassador, Cities played after that will not count that pile as empty. An empty trash pile does not count for this.",
    "type": "Action",
    "buys": 0,
    "treasure": 0,
    "cards": 0,
  ...
  },
  {
    ...
    "cost": 7,
    "set": 5,
    "text": "Trash any number of cards from your hand. Gain a card with cost exactly equal to the total cost of the trashed cards.",
    "description": "\"Any number\" includes zero. If you trash no cards, you have to gain a card costing 0 coins if you can. This is different from how cards like Expand work if you do not trash anything, because Forge looks at the total, not at any one card's cost. If there is no card at the required cost, you do not gain a card. The card you gain comes from the Supply and is put into your discard pile. Potion symbols (on cards from Dominion: Alchemy) are not added, and the card you gain cannot have a Potion symbol in its cost.",
    "type": "Action",
    "actions": 0,
    "buys": 0,
    "treasure": 0,
  ...
  },
  {
    ...
    "treasure": 2,
    "set": 5,
    "text": "Each other player discards down to three cards in hand. While this is in play, when you buy a card, +1 VP Chip.",
  ...
  },
  {
    ...
    "set": 5,
    "text": "",
    "description": "See the Additional Rules section for rules on VP tokens.",
    "type": "Action",
    "actions": 0,
    "buys": 0,
    "cards": 0,
  ...
  },
  {
    ...
    "treasure": 1,
    "set": 5,
    "text": "During your Buy phase, this costs 2 Coin less per Action card you have in play, but not less than 0.",
    "description": "Most of the time, this costs 8 coins. During Buy phases, this costs 2 coins less per Action card you have in play. This cost applies to all Peddler cards, including ones in hands and decks. It never costs less than 0 coins. If you play King's Court on Worker's Village, for example, that is just two Action cards you have in play, even though you played the Worker's Village three times. Buying cards using the promotional card Black Market is something that does not happen during a Buy phase, so Peddler still costs 8 coins then.",
    "type": "Action",
    "buys": 0,
    "cards": 0,
    "victoryPoints": 0,
  ...
  },
  {
    ...
    "treasure": 1,
    "set": 5,
    "text": "While this is in play, when you buy a card costing 4 Coin or less that is not a Victory card, gain a copy of it.",
    "description": "This is a Treasure worth 1 coin like Copper. Each time you buy a non-Victory card costing 4 coins or less with this in play, you gain another copy of the bought card. If there are no copies left, you do not gain one. The gained card comes from the Supply and goes into your discard pile. If you have multiple Talismans, you gain an additional copy for each one; if you buy multiple cards for 4 coins or less, Talisman applies to each one. For example if you have two Talismans, four Coppers, and two Buys, you could buy Silver and Trade Route, gaining two more Silvers and two more Trade Routes. Talisman only affects buying cards; it does not work on cards gained other ways, such as with Expand. A card is a Victory card if Victory is any of its types; for example Great Hall from Dominion: Intrigue is an Action - Victory card, so it is a Victory card. Talisman only cares about the cost of the card when you buy it, not its normal cost; so for example it can get you a Peddler if you have played two Actions this turn, thus lowering Peddlerâ€™s cost to 4 coins, or can get you a Grand Market if you played Quarry.",
    "type": "Treasure",
    "actions": 0,
    "buys": 0,
    "cards": 0,
  ...
  },
  {
    ...
    "cost": 3,
    "set": 5,
    "text": "Draw until you have 6 cards in hand. (Reaction) When you gain a card, you may reveal this from your hand. If you do, either trash that card or put it on top of your deck.",
